...
void lightning_attn2_kernel(const lightning_attn2_globals globals, int N)
{
    ...
    row_vec<st_fl<ATTN_D__128, CHUNK_SIZE__64, st_32x32_s>> (&q_decay) = al.allocate<row_vec<st_fl<ATTN_D__128, CHUNK_SIZE__64, st_32x32_s>>>();      // 64x4 = 256 B
    row_vec<st_fl<ATTN_D__128, CHUNK_SIZE__64, st_32x32_s>> (&k_decay) = al.allocate<row_vec<st_fl<ATTN_D__128, CHUNK_SIZE__64, st_32x32_s>>>();      // 64x4 = 256 B
    // decay in register
    ...
    constexpr int memcpy_per_tile_v_todo = CHUNK_SIZE__64 * V_CHUNK_SIZE__32 * sizeof(T);
...
lightning_attn2_globals lightning_attn2_init(
    ...
    unsigned long B, unsigned long H, unsigned long N__64
) {
    // global pointers. 
    ...
    _gl_QKVO             q_arg{d_q, B, N__64, H, ATTN_F__128};
    _gl_QKVO             k_arg{d_k, B, N__64, H, ATTN_F__128};
    _gl_QKVO             k_split_arg{d_k, B, N__64, H, ATTN_F__128}; 
    _gl_QKVO             v_arg{d_v, B, N__64, H, ATTN_D__128};
    _gl_QKVO             o_arg{d_o, B, N__64, H, ATTN_D__128};

    // debug dump
    _gl_QKVO            odebug_arg{d_debug_o, B, N__64, H, ATTN_D__128};
